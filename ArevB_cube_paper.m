%% Info
% Run "ArevB_fkm_paper.m" first! The result file is needed for this script
...
opt.worker  = 2;        % parallel compute threads
tic;
R=QB(f,Kinit,...
    zeros(1,length(kopt)),...
